...
?>
			...
			<?php endif; ?>
			<?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_84758200_1422848991');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_84758200_1422848991']):
?>
      <div class="screeBox">
			<strong><?php echo htmlspecialchars($this->_var['filter_attr_0_84758200_1422848991']['filter_attr_name']); ?> :</strong>
			<?php $_from = $this->_var['filter_attr_0_84758200_1422848991']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):

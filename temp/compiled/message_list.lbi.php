...
?>
      ...
      [<b><?php echo $this->_var['msg']['msg_type']; ?></b>]&nbsp;<?php echo $this->_var['msg']['user_name']; ?><?php if ($this->_var['msg']['user_name'] == ''): ?><?php echo $this->_var['lang']['anonymous']; ?><?php endif; ?>：<?php if ($this->_var['msg']['id_value'] > 0): ?><?php echo $this->_var['lang']['feed_user_comment']; ?><b><a class="f3" href="<?php echo $this->_var['msg']['goods_url']; ?>" target="_blank" title="<?php echo $this->_var['msg']['goods_name']; ?>"><?php echo $this->_var['msg']['goods_name']; ?></a></b><?php endif; ?><font class="f4"><?php echo $this->_var['msg']['msg_title']; ?></font> (<?php echo $this->_var['msg']['msg_time']; ?>)<?php if ($this->_var['msg']['comment_rank'] > 0): ?><img style="position:absolute; right:0px;" src="themes/ecmoban_dangdang/images/stars<?php echo $this->_var['msg']['comment_rank']; ?>.gif" alt="<?php echo $this->_var['msg']['comment_rank']; ?>" /><?php endif; ?>
      </div>
